            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2" style="float: right;">
                        <a href="{{ route('unit.create') }}" class="btn btn-primary btn-sm"><i
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, col) {
                            ...
                            returnData += '<a href="' + utlt.siteUrl('admin/unit/' + data +
                                    '/edit') +
            ...
            $(document).on('click', '.deleteItem', function() {
                ...
                Swal.fire(config).then(function(result) {
                    if (result.value === true) {
                        utlt.Delete('admin/unit/' + $el.attr('data-val'), '#dataTable');
                    }
                });
            });
