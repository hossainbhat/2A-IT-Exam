            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2" style="float: right;">
                        <a href="{{ route('brand.create') }}" class="btn btn-primary btn-sm"><i
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, col) {
                            if (data) {
                                return `<img src="/uploads/logo/${data}" alt="Logo" style="width:40px; height:40px; object-fit:contain;">`;
                            } else {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, col) {
                            ...
                            returnData += '<a href="' + utlt.siteUrl('admin/brand/' + data +
                                    '/edit') +
            ...
            $(document).on('click', '.deleteItem', function() {
                ...
                Swal.fire(config).then(function(result) {
                    if (result.value === true) {
                        utlt.Delete('admin/brand/' + $el.attr('data-val'), '#dataTable');
                    }
                });
            });
